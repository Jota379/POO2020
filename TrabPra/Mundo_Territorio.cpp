...
Territorio_Inicial::Territorio_Inicial(string nome, int resistencia, int produtos, int ouro, int pontos_vitoria) {
...
string Mundo_Territorios::getAsString() const {
    ...
    oss << nome_territorio << "\t" << resistencia << "\t" << produtos << "\t" << ouro << "\t" << pontos_vitoria << "\t" << conquistado << endl;
    return oss.str();
}
